...
flags.DEFINE_string("dataset", "history_2", "The name of dataset [celebA, mnist, lsun]")
  ...
  with tf.Session(config=run_config) as sess:
    if FLAGS.dataset == 'mnist':
      ...
      dcgan = DCGAN(
          ...
          sample_dir=FLAGS.sample_dir,
          data_dir=FLAGS.data_dir)
      #python main.py --input_width=128 --input_height=128 --output_width=128 --output_height=128 --batch_size=30 
